...
def preprocess(
    ...
    flair_dir = os.path.join(COHORT_DIR, DATASET_NAME, 'FLAIR', 'Raw')
    ...
    for file in files:
        ...
        nifti_data_s = np.copy(flair_data) # to be removed 
...
if __name__ == '__main__':
    ...
    DATASET_NAME = 'Public_MSSEG' # choose from 'Local_SAI' or 'Public_MSSEG'
